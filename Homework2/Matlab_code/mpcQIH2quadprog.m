function [H,T,Aineq,bineq,Aeq,beq] = mpcQIH2quadprog(Ad,Bd,Q,R,P,delta,N,xt,unormbound)
...
Aequ = kron(eye(N),Bd);
% Aequ = [zeros(n,N*m); Aequ; zeros(n,N*m)]; %OLD
